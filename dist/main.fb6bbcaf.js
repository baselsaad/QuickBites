...
reservationForm.addEventListener('submit', /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 5;
                    return fetch('http://localhost:8081/v1/create/reservation', {
                      method: 'POST',
                      headers: {
            ...
            var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(res) {
              ...
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return fetch('http://localhost:8081/v1/book/' + username + '/' + res.bookingId, {
                      method: 'PUT',
                      headers: {
                        'Content-Type': 'application/json'
                      },
