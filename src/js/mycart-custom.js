...
function handleClick(e) {
  ...
  const targetMenu2 = document.querySelector(`#${this.dataset.target}`);
  menus.forEach(menu => {
    menu.classList.remove('lunch--is-visible');
    targetMenu.classList.add('lunch--is-visible');
    
  })
  
  const targetMenu3 = document.querySelector(`#${this.dataset.target}`);
  menus.forEach(menu => {
    menu.classList.remove('drinks--is-visible');
    targetMenu.classList.add('drinks--is-visible');
    
  })
  const targetMenu4 = document.querySelector(`#${this.dataset.target}`);
  menus.forEach(menu => {
    menu.classList.remove('desserts--is-visible');
    targetMenu.classList.add('desserts--is-visible');
